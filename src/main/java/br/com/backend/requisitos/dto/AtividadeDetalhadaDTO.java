...
public class AtividadeDetalhadaDTO {
	...
	public AtividadeDetalhadaDTO(Atividade atividade) {
		...
		requisito = new RequisitoDTO(atividade.getRequisito());
		criadoPor = new IntegranteDTO(atividade.getCriador());
		desenvolvidos = listaIntegrantesDesenvolvedores(atividade.getDesenvolvedores());
	}
